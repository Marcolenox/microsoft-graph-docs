...
-->
``` http
PATCH /accessReviewSet/decisions/{accessReviewInstanceDecisionItemId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/accessReviewSet/decisions/{accessReviewInstanceDecisionItemId}
...
{
  "@odata.type": "#microsoft.graph.accessReviewInstanceDecisionItem",
  "id": "7ee5ebd9-ebd9-7ee5-d9eb-e57ed9ebe57e",
  "accessReviewId": "String",
  "reviewedBy": {
    "@odata.type": "microsoft.graph.userIdentity"
  },
