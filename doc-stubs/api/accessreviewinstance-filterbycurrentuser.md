...
-->
``` http
GET /accessReviewScheduleDefinition/instances/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/accessReviewScheduleDefinition/instances/filterByCurrentUser(on='parameterValue')
```
