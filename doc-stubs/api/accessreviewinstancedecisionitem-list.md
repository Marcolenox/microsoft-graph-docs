...
-->
``` http
GET /accessReviewScheduleDefinition/instances/{accessReviewInstanceId}/decisions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/accessReviewScheduleDefinition/instances/{accessReviewInstanceId}/decisions
```
