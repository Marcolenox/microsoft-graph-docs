...
-->
``` http
GET ** Collection URI for microsoft.azure.termsOfUse.user not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.azure.termsOfUse.user not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.azure.termsOfUse.user)"
}
-->
``` http
HTTP/1.1 200 OK
