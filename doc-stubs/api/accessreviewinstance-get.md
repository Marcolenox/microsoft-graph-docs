...
-->
``` http
GET /accessReviewScheduleDefinition/instances/{accessReviewInstanceId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/accessReviewScheduleDefinition/instances/{accessReviewInstanceId}
```
