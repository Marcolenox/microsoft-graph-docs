...
-->
``` http
GET /accessReviewSet/decisions/{accessReviewInstanceDecisionItemId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/accessReviewSet/decisions/{accessReviewInstanceDecisionItemId}
```
