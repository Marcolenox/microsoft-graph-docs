...
-->
``` http
GET /accessReviewScheduleDefinition/instances/{accessReviewInstanceId}/decisions/filterByCurrentUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/accessReviewScheduleDefinition/instances/{accessReviewInstanceId}/decisions/filterByCurrentUser(on='parameterValue')
```
